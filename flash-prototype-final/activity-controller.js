flashApp.controller("ActivityController", ["$scope", function ($scope) {

  var date = new Date();
  $scope.activities = [{
    type: "given",
    date: date.setMinutes(10),
    recipients: [{firstName: "Josh", lastName: "Speerstra"}, {firstName: "Joe", lastName: "Davis"}],
    submitter: null,
    ...
    recipients: null,
    submitter: {firstName: "Allen", lastName: "Himler"},
    ...
    recipients: null,
    submitter: {firstName: "Pirooz", lastName: "Javan"},
    commendations: ["Quality"],
    description: "For making sweet UIs."
  }, {
    type: "given",
    date: date.setMinutes(25),
    recipients: [{firstName: "Pranav", lastName: "Kothare"}],
    submitter: null,
    commendations: [],
